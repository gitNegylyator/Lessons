...
import lesson4.Homework2.Cat;
import lesson4.Homework2.Dog;
...
public class HomeWork2 {
        public static void main(String[] args) {
            ...
            System.out.print((hi.trim() + world + newLine).repeat(3));
            ...
            Cat cat = new Cat(2, "Pushok");
            Dog dog = new Dog( 5, "Sharik");
            System.out.println("\n"+ cat.name+ " " + cat.age + " года\n" + dog.name + " " + dog.age + " лет" );
            ...
            double result = 0;
            if (increment > 0) {
            for (double i = increment; i <= 1_000_000; i += increment) {
                result++;
            ...
            int[] array = {1, 1, 1, 1, 1};
            // необходимо перебрать массив циклом,
            // в цикле проверить условие если % == 0, оставляем число, если нет элемент нечетный, меняем его на 0
            // записываем новый массив и выводим его на экран.
            ...
            int[] array3 = new int[array1.length * 3];
            int count = 0;
            ...
            System.out.println("\n" + newstring.replace('l', 'r').toUpperCase(Locale.ROOT).substring(0, 8));
